　// === GAME GUIDE - SLOT ADDED ===
const Guide = {
  st: 'list', // 'list' or 'detail'
  cur: 0,
  scroll: 0,
  ...
  draw() {
    ...
    if (this.st === 'list') {
      ...
      ctx.fillText('A: 読む  SELECT: 戻る', 35, 280);
      ...
      ctx.fillStyle = '#888'; ctx.font = '10px monospace';
      ctx.fillText('↑↓: スクロール  B: 戻る', 25, 285);
    }
  }
};
