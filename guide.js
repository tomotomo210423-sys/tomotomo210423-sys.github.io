...
const Guide = {
    ...
    games: [
        ...
        {
            name: "CURSED MANOR",
            icon: "0000000001111110122222211241142112222221011111100004400000400400",
            text: "呪われた洋館から脱出する最恐の2Dサバイバルホラーじゃ！\n\n【操作】\n十字キー: 移動\nAボタン: 調べる / 隠れる / パズルの決定\nBボタン: パズルや日記から戻る\n\n【システム】\n館を徘徊する「蠢く肉塊(バケモノ)」から逃げながら、謎を解いて3つの鍵を集めるのじゃ！\n敵が近づくと心音が鳴り響き、画面が赤く脈打つぞ！\n見つかったら「青いロッカー」を見つけてAボタンで息を潜めるのじゃ。\n\n【謎解きと日記】\n金庫、ピアノ、配電盤の謎を解かないと鍵は手に入らん！\n館に落ちている「破られた日記」を読むと恐ろしい真相がわかるぞ。すべての日記を読んでから脱出すると…？\n\n【⚠ 究極の恐怖】\n謎解き中や、日記を読んでいる最中も時間は止まらん！裏でバケモノが容赦なく迫ってくるゆえ、心音に耳を澄ませるのじゃ！"
        },
        {
            name: "CHAIN BLAST",
            icon: "0550033055553333555533330550033004400660444466664444666604400660",
            text: "同じ色のブロックをつなげて消すシンプル爽快パズルじゃ！\n\n【操作】\n十字キー: カーソルの移動\nAボタン: カーソル位置のブロックグループを消去\nSELECT: メニューに戻る\n\n【システム】\n8×8のグリッドに並んだカラーブロックの中から、2つ以上つながった同色グループをAボタンで一気に消去！\n消せるグループにはハイライトが入るぞ。残り手数がゼロになるとゲームオーバーじゃ。\n\n【スコアの仕組み】\n消したブロックの数が多いほど、スコアは爆発的に増える！\n消去数×消去数×5ポイントが入るゆえ、大きなグループを狙うのじゃ！\n\n【全消しボーナス】\n盤面を完全に空にすると、ボーナス500点！さらにレベルが上がり、色数と難易度が増すぞ。残り手数も10手追加されるから積極的に狙うのじゃ！"
        },
        {
            name: "DUNGEON CRAWL",
            icon: "3333333334444443381111833411114334111143341111433411114333333333",
            text: "ランダム生成ダンジョンを潜るターン制ローグライクじゃ！\n\n【操作】\n十字キー: 移動 (敵に向かって押すと攻撃！)\nBボタン: ポーション使用 (HP半分回復)\nSELECT: メニューに戻る\n\n【システム】\n自分が1歩動くと、敵も1歩動くターン制じゃ。\n視界は半径4マス。暗闇の先に何が潜むかは行ってみないとわからんぞ！\n光る階段を見つけて、より深い階へ潜るのじゃ。\n\n【敵の種類】\n・スライム: 動きが遅い(2ターンに1歩)。初心者向けの獲物じゃ\n・スケルトン: 標準的な追跡者\n・メイジ: 直線3マスから魔法弾を撃ってくる！遮蔽物を使え！\n・ドラゴン: 5階ごとのボス。倒せば100Gと大量EXPじゃ！\n\n【成長】\n敵を倒してEXPを稼ぐとレベルアップ！HP全回復+攻撃力アップじゃ。\n宝箱からはポーションやゴールドが出るぞ。\n\n【スコア】\nゴールド＋階数×100。死んだら終わりの一発勝負じゃ！\n最深階とベストスコアは自動保存されるぞ。"
        },
        {
            name: "GALAXY BREAK",
            icon: "7777777770000777700077770007777700007770777077700070007007770070",
            text: "4章構成のストーリー型スペースアドベンチャーじゃ！章ごとに異なるゲームが楽しめるぞ！\n\n【CH1: PIPE REPAIR】\nパイプを回転させてエネルギー経路を繋げ！\n十字キーでカーソル移動、Aで回転。60秒以内に完成させよ！\n\n【CH2: ASTEROID FIELD】\n小惑星帯を30秒間生き延びろ！\n左右キーで回避、Aでブースト。⚡燃料を集めないと燃料切れで死亡じゃ！\n\n【CH3: STAR MINER】\n惑星に不時着！Aキーで隣接マスを掘り、クリスタルを10個集めよ。5個集めると敵スライムが出現するぞ！\n\n【CH4: BOSS BATTLE】\n敵帝国艦との最終決戦！左右で弾避け、Aで反撃弾を撃て！\nボスは体力が減るほど弾幕が激化する3フェーズ制じゃ！\n\n【共通】\nライフ3つ、残機制。各チャプター間にストーリーが展開するぞ。\nスコアはチャプタークリアタイムとボス撃破ボーナスで決まる。"
        },
    ],
    ...
    draw() {
        ...
        if (this.st === 'list') {
            ...
            for (let line of this.lines) {
                ...
                if (line.includes('【')) {
                    ctx.fillStyle = '#ff0';
                } else if (line.includes('⚠') || line.includes('究極の恐怖') || line.includes('ゲームオーバー')) {
                    ctx.fillStyle = '#f55';
