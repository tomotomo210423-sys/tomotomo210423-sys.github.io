// === GUIDE APP (Remake: Cyber Archive Edition - 14in1) ===
...
const Guide = {
    ...
    games: [
        ...
        },
        {
            ...
            text: "4章構成のストーリー型スペースアドベンチャーじゃ！パイプ修理、小惑星帯突破、星の採掘、そしてボス戦じゃ！\n\n【操作】\n十字キー: 移動・選択\nAボタン: 決定・アクション\nBボタン: キャンセル\n\n【4つの章】\n1章: パイプ修理 - 漏れているパイプを素早く修理！\n2章: 小惑星帯 - 隕石を避けながら宇宙を突き進め！\n3章: 星の採掘 - レーザーで鉱石を掘り出せ！\n4章: ボス戦 - 銀河の守護者と最終決戦！",
        },
    ],
