...
const Guide = {
    ...
    games: [
        ...
        {
            name: "TURBO DASH",
            icon: "0000000000ff000000fff00000f0f00000f00f0000f000f00f00000f0f00000f",
            text: "爆音の靴を履いた特殊工作員エコーが全力ダッシュするランナーゲームじゃ！\n\n【操作】\nAボタン: ジャンプ（空中でもう一度押すと2段ジャンプ！）\n↓ (下キー): しゃがみ(天井の障害物を避ける)\nSELECT: メニューに戻る\n\n【システム】\nエコーは自動で右に走り続ける。迫りくる障害物を避け、コインを集めるのじゃ！\n走れば走るほどスピードが上がり、どんどんシビアになるぞ！\n\n【障害物の種類】\n・赤い低い壁: ジャンプで越えろ！\n・天井の長い壁: しゃがんで潜り抜けろ！\n・高い壁: 2段ジャンプが有効じゃ！\n\n【スコア計算】\n走った距離＋拾ったコイン×10点 が合計スコアじゃ！\nベストスコアは自動保存されるぞ！"
        },
    ],
