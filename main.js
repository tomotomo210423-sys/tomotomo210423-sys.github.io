...
const BGM = {
  ...
  play(type) {
    ...
    const mels = {
      ...
      boss:    { t1:[494,523,494,440,466,494,523,587], t2:[247,262,247,220,233,247,262,294], t3:[123,0,123,110,116,123,0,147], n:[1,0,1,1,0,1,0,1], spd:175 },
      puzzle:  { t1:[330,294,262,294,330,392,349,330], t2:[165,147,131,147,165,196,174,165], t3:[0,0,65,0,82,0,87,0], n:[0,0,0,0,0,0,0,0], spd:360 },
      dungeon: { t1:[220,208,196,185,175,185,196,208], t2:[110,104,98,92,87,92,98,104], t3:[55,0,49,0,43,0,49,0], n:[0,1,0,1,0,1,0,1], spd:285 },
      stealth: { t1:[262,247,233,220,233,247,0,0], t2:[131,123,116,110,116,123,0,0], t3:[65,61,58,55,58,61,0,0], n:[0,0,0,0,0,0,0,0], spd:420 },
      slots:   { t1:[523,659,784,880,784,659,523,440], t2:[262,330,392,440,392,330,262,220], t3:[131,165,196,220,196,165,131,110], n:[0,0,1,1,1,0,0,0], spd:145 },
...
const Menu = {
  ...
  apps: ['ゲーム解説館', 'テトリベーダー V2', '理不尽ブラザーズ', 'ONLINE対戦', 'BEAT BROS', 'レトロ・スロット', '無限無双', 'アビス・ジェネラル', '爆音スニーキング', 'ハッカーズ15', 'PIXEL BIOTOPE', 'CURSED MANOR', 'CHAIN BLAST', 'DUNGEON CRAWL', 'GALAXY BREAK', 'システム設定'],
  ...
  update() {
    ...
    if (keysDown.a) {
        ...
        const appObjs = [
            ...
            typeof DungeonCrawl !== 'undefined' ? DungeonCrawl : null,
            typeof GalaxyBreak !== 'undefined' ? GalaxyBreak : null,
