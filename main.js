...
const drawSprite = (x, y, color, strData, size = 2.5) => {
  ...
  // ★ 強力な安全装置：文字数が100を超えていれば強制的に16x16として計算し画像崩れを阻止
...
const sprs = {
  ...
  // ★ リメイク版ペペロンチーノ（赤唐辛子とニンニク乗せ）
  peperoncino: "00000000000000000000000000000000000003330000000000003858300000000003825830000000008888888000000008898898800000002222222220000002a22a2a2a20000022a2a2a2a2200000222222222200000022222222000000000000000000000000000000000000",
