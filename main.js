// === CORE SYSTEM - STABLE VERSION WITH NEW PEPERONCINO SKIN ===
...
const sprs = {
  ...
  enemyNew: ["00000000000000000000030000000300000031300000313000031130000311300031113000311130031111330331111331111113331111113111111111111111311111111111111131131111111113113130311111113031330003311133000300000003330000000000000000000000000000000000000000", "00000000000000000000000000000000000000000000000030000000000000033300000000000033313000000000031331130003300031133111303113031113031113311331113003111111111111300031111111111300000313111131300000003033330300000000000000000000000000000000000000000000000"],
  ...
  // ★ ここが新しいペペロンチーノのドット絵データです！
  peperoncino: "",
  ...
  coin: ["0003300000388300038888300383830003838300038383000038830000033000","00033000003883000388883003888830038888300388883003888830038888300038830000033000"],
...
window.addEventListener('keydown', e => {
  ...
  if (e.key === 'z' || e.key === ' ') keys.a = true; if (e.key === 'x') keys.b = true; if (e.key === 'Shift') keys.select = true;
});
