// === CORE SYSTEM - SLOT MACHINE ADDED ===
...
const SaveSys = {
  data: (function() {
    ...
    // ★ スロット用のコインデータ(slotCoins)を追加
    return { playerName: d.playerName || 'PLAYER', scores: d.scores, actStage: d.actStage || 1, actLives: d.actLives || 5, actSeed: d.actSeed || 1, rpg: d.rpg || null, rankings: d.rankings, bgTheme: d.bgTheme || 0, rhythm: d.rhythm, slotCoins: d.slotCoins || 100 };
  })(),
